...
resource "aws_ecs_service" "this" {
  ...
  // 本番であれば、P277 の例を参考に capacity_provider_strategy を指定する。
  ...
  load_balancer {
    ...
    container_port   = 80
    target_group_arn = data.terraform_remote_state.routing_tsubasa_link.outputs.lb_target_group_foobar_arn
  }
